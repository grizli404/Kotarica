...
class OceneModel extends ChangeNotifier {
  ...
  Future<void> oceniProizvod(
    ...
    var endpointUrl = 'http://147.91.204.116:11094/dodajKupovinu?idKorisnika='+korisnikInfo.id.toString()+'&idKategorije='+p.idKategorije.toString()+'&idProizvoda='+_idProdavca.toString()+'&ocena='+_ocena.toString()+'&idProdavca='+_idProdavca.toString();
